...
\hypersetup{
  ...
  pdfsubject={Meta-harness optimization loop wired onto Islo sandboxes (islo.dev)},
  pdfkeywords={meta-harness, islo, islo.dev, harbor, agent eval, harness optimization}
}
...
traces cheaply. Which is exactly what \href{https://islo.dev/}{Islo} sandboxes
already do.
...
\href{https://zozo123.github.io/meta-harness-on-islo-page/}{\texttt{zozo123.github.io/meta-harness-on-islo-page}} $\cdot$
\href{https://github.com/zozo123/meta-harness-on-islo}{\texttt{github.com/zozo123/meta-harness-on-islo}}\\[0.3em]
Built on \href{https://islo.dev/}{\texttt{islo.dev}}\\[0.3em]
